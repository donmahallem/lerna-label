...
export const getChangedFiles = async (octokit: Octokit, params: PRListFilesParameter): Promise<string[]> => {
    const listFilesResponse: PRListFilesResponse = await octokit.request('GET /repos/{owner}/{repo}/pulls/{pull_number}/files', params);
